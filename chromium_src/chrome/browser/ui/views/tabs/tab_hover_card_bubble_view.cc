...
void TabHoverCardBubbleView_ChromiumImpl::BeaconUpdateCardContent(
    const Tab* tab) {
  ...
  // Replace chrome:// with beacon://. Since this is purely in the UI we can
