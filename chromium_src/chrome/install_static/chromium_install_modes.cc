// Brand-specific constants and install modes for Beacon.
...
const wchar_t kCompanyPathName[] = L"Impervious";

const wchar_t kProductPathName[] = L"Beacon";
...
const InstallConstants kInstallModes[] = {
    // The primary (and only) install mode for Chromium.
    {
        ...
        L"Beacon",  // A distinct base_app_name.
        L"Beacon",  // A distinct base_app_id.
        L"BeaconHTM",                             // ProgID prefix.
        L"Beacon HTML Document",                  // ProgID description.
        L"{7D2B3E1D-D564-4594-9D8F-A6667F12E0AC}",  // Active Setup GUID.
        L"{A2DF06F9-3651-44A8-8A99-8B9C84F29160}",  // CommandExecuteImpl CLSID.
        {0x635EFA6F,
         0xC076,
         0x4EC9,
        ...
        {0xb88c45b9,
         ...
         {0xb8, 0x3e, 0x77, 0xcc, 0x67, 0xd9, 0xce,
          0xed}},  // IElevator IID and TypeLib
                   // {B88C45B9-8826-4629-B83E-77CC67D9CEED}.
