...
void BeaconProfileMenuView::BuildIdentity() {
...
void BeaconProfileMenuView::BuildAutofillButtons() {}

// We don't want to show any Chromium sync info.
void BeaconProfileMenuView::BuildSyncInfo() {}

// We don't want feature buttons to manage google account
void BeaconProfileMenuView::BuildFeatureButtons() {
  Profile* profile = browser()->profile();
...
gfx::ImageSkia BeaconProfileMenuView::GetSyncIcon() const {
